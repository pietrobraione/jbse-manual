...
.. figure:: ../img/doubleif_symbolic_tree_static.svg
   :align: center
...
.. figure:: ../img/loop_symbolic_tree.svg
   :align: center
...
.. figure:: ../img/loop_symbolic_tree_path.svg
   :align: center
...
We have said that symbolic execution at the ``node.swap()`` statement must consider *at least* :math:`N + 1` cases: Should it consider more for the analysis to be case-complete? The answer to this question is found in `this paper`_, which introduces a technique, called "lazy initialization", that is used in JBSE to resolve the use of a symbolic reference at a certain point of the symbolic execution. The cases to be considered are:
